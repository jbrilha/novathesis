...
Application-layer IoT protocols typically focus on interoperability and
efficient data exchange under stable connectivity assumptions rather than
autonomous operation during infrastructure loss. At the application layer, two
messaging protocols stand out given their wide-spread adoption in \gls{iot}
deployments:
...
relevant to resilient and decentralized \gls{iot} deployments, as they  are
commonly adopted in due to their low energy consumption and hardware
