...
\todo{em vez de "iot systems":\\ smart systems?}
systems span multiple
dimensions:
\begin{description}
...
\gls{SDN} controllers, or others) concentrate the risk of failure in single
...
for coordinating multi-protocol communication without master nodes;
...
\gls{ubabel}'s contributions relative to the current state of the art.

\todo{FIXED: updated security section description}
