...
\begin{description}
    ...
    \item \textbf{Domotics systems}~\cite{domoticstaxonomy2025,domotics2019}
...
In the remainder of this work, these two domains are collectively referred to
as \textbf{\glspl{ISE}}, to emphasize their shared integration of networked
computation, sensing, and physical actuation.\\

The challenges faced in disaster-resilient \glspl{ISE} span multiple
dimensions:
\begin{description}
...
These challenges are fundamentally architectural: existing \glspl{ISE} are
designed around the assumption of stable infrastructure, treating network
partitions and coordinator failures as transient anomalies rather than the
norm.
...
with inter-device coordination and radio heterogeneity with low resource
usage.
...
Naturally, this requires a fundamental rethinking of \gls{ISE} design:
how devices discover and communicate with each other using diverse communication
