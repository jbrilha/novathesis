...
\todo{FIXED? umbrella term, ainda não atualizei o resto do doc, pending approval}
In the remainder of this work, these two domains are collectively referred to
as \glspl{CPS}~\cite{cps2017review,cps2009,cps2017}, to emphasize their shared
integration of networked computation, sensing, and physical actuation.\\

The challenges faced by disaster-resilient \glspl{CPS} 
