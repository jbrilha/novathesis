...
through the exploitation of protocol diversity.
...
resorting to persistent infrastructure. \gls{ubabel}'s approach to
decentralized protocol selection is detailed in Section
\ref{component:protocol_manager} along with masterless synchronization
mechanisms.
