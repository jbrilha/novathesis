...
caused by debris, obstacles blocking line-of-sight propagation, or damage to
access points which may become unavailable as a result.
...
through the exploration of protocol diversity.
...
\gls{ESP-NOW}, \gls{ZigBee}, and \gls{Modbus} protocols on devices from the ESP32 family to
