...
partial views for scalability: a small \emph{active view} (size = fanout + 1)
containing nodes with which symmetric links are actively maintained, and a
larger \emph{passive view} serving as a backup pool of potential neighbors that
may be promoted to the \emph{active view} if one of its nodes fails.
