...
\todo{FIXED: ""é bom? é mau? é adequado?""}
...
\todo{outra vez o paper do MDPI.... retirar por completo, fingir que não vi?}
...
\gls{ubabel}'s approach (Section~\ref{subsec:microbabel_approach_4}) should,
therefore, consider lightweight prediction and compression in multi-protocol
scenarios with per-protocol thresholds and strategy selection while accounting
for gateway receiver energy costs.
\todo{TODO: retirar receiver energy stuff se retirar o paper do MDPI}
