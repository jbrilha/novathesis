...
\textbf{MicroBabel} addresses these challenges through a decentralized approach
...
Protocol for Low-Power and Lossy Networks) with three separate instances to
differentiate traffic by priority: human data (voice/text via Bluetooth)
receives the highest priority, followed by drone-collected data and finally
sensor data.
