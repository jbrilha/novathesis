...
\todo{algo sobre validar energy costs?}

\paragraph{Integration Testing:}
System properties are evaluated for different metrics:
...
\begin{description}
	...
	\item[Task 3 -- Coordination Layer:] Coordination and Synchronization
	      mechanisms
	      \begin{description}
		      \item[Task 3.1:] Synchronization Service
	      \end{description}

	\item[Task 4 -- Data Management]: Lightweight reduction and compression
	      strategies
	      \begin{description}
		      \item[Task 4.1:] Message Queue Manager
		      \item[Task 4.2:] Compression Service
	      \end{description}
