...
2030\cite{sinha2025stateofiot}. Industry analysts estimate that IoT
technologies could unlock between \$5.5 and \$12.6 trillion in economic value
by 2030~\cite{mckinsey2021iot}.
...
acute in disaster response and emergency scenarios, where additional
difficulties arise: communication infrastructure failing precisely when needed
most, rapid deployment with little configuration becoming essential, and
autonomous operation transitioning desirable to indispensable.
