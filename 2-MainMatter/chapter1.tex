...
\todo{A pragmatic issue in the context of smart homes is that without cloud
...
physically present.}
\todo{REMOVED para o chap1 não passar da pág. 4}
...
\todo{FIXED: multi-protocol -> multi-radio mas dar atenção à literatura}
...
~\ref{sec:system_model}).\todo{TODO: validar esta definição please} Neither of
these terms should be confused with \emph{multi-channel}, which refers to
frequency diversity within a single radio technology stack (e.g., 2.4GHz Wi-Fi
channels 1-13, \gls{LoRa} frequency hopping).
