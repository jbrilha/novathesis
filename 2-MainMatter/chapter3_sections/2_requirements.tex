...
highlight a set of \glspl{FR} that \gls{ubabel} must meet in order to eliminate
the \emph{dependency} on centralized coordination, continuous connectivity, and
cloud infrastructure; and a set of \glspl{NFR} which would strengthen the
overall quality of the framework and ensure it can be widely adopted with ease.
