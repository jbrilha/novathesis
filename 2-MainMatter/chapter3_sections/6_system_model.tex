...
Service. The topology manager can exploit neighbor heterogeneity (e.g.,
available radio technologies, distance, processing capabilities) to enhance
overlay resilience through diversified connectivity.
