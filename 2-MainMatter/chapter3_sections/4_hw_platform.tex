...
\glspl{ISE}. The following sections cover device specifications and radio
technology characteristics, establishing the foundation for our hybrid
architecture.
...
\begin{table}[htbp]
	...
	\begin{tabular}{@{}lccccc@{}}
		...
		\multicolumn{6}{p{\linewidth}}{\footnotesize
			...
			but we focus on \gls{ZigBee} given its wider adoption in \glspl{ISE}
		}                                                                                                                                    \\
		\multicolumn{6}{p{\linewidth}}{\footnotesize
