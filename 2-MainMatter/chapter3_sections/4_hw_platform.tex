...
Together, these Class-1 specifications and multi-protocol capabilities
establish the core hardware foundation for \gls{ubabel}'s autonomous operation.
Section~\ref{sec:system_model} details how these resources are exploited
