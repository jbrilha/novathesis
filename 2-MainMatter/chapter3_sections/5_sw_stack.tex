...
\paragraph{Operating System Layer}
...
This allows multiple communication components and I/O handlers to execute
...
\paragraph{Platform SDKs and Hardware Abstractions}
...
coordination logic across Class-1 devices. \gls{ubabel} will be implemented in
C, as it allows precise control over memory usage, interrupt behavior, and
timing, which are essential in embedded environments with limited memory and
